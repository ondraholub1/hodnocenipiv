      ...
      <div className="w-full max-w-md bg-gray-800/50 backdrop-blur-xl p-8 rounded-3xl shadow-[0_0_40px_rgba(0,0,0,0.5)] border border-gray-700 relative overflow-hidden">
        ...
        <div className="relative z-10">
          <div className="text-center mb-8">
            ...
            <p className="text-gray-400 mt-2 font-medium">Přihlas se a ohodnoť další pivo</p>
          </div>
          ...
          <p className="text-center text-gray-400 mt-8 text-sm">
            Nemáš ještě účet?{" "}
            <Link href="/signup" className="text-amber-500 font-bold hover:text-amber-400 hover:underline transition-all">
              Zaregistruj se
            </Link>
          </p>
        </div>
