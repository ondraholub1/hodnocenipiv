...
export default function SignupPage() {
  ...
  const handleSignup = async (e: React.FormEvent) => {
    ...
    if (error) {
      ...
      alert("Registrace proběhla úspěšně! Teď se můžeš přihlásit.");
      router.push("/login");
    }
    setLoading(false);
  };
  ...
  return (
    // Stejný elegantní gradient jako u přihlašování
    <main className="min-h-screen flex items-center justify-center p-4 bg-gradient-to-br from-amber-400 via-orange-500 to-amber-900">
      ...
      <div className="bg-white p-8 rounded-2xl shadow-2xl w-full max-w-md border border-orange-200">
        <div className="text-center mb-8">
          ...
          <p className="text-gray-500 mt-2">Staň se součástí naší pivní komunity.</p>
        </div>
